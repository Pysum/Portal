...
def fetch_all_feedback_data(name):
    ...
    with open(file_path, 'r') as csv_file:
        ...
        for row in csv_reader:
            ...
            if feedback_id not in acknowledged_feedback_ids:  # Check if the feedback_id is not in the set
                user_data.append({
                    'Date': row['Date'],
                    ...
                    'Acknowledged': False  # Since we are not adding acknowledged IDs, we set it to False.
                })
